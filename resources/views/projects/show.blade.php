...
<header class="flex items-center mb-6 py-4">
    ...
    <div class="flex justify-between w-full items-end">
     <p class="text-muted text-white font-white"> 
         <a href="/projects" class="text-muted font-xl no-underline hover:underline">Type of help</a> / {{$project->title}}
        </p>
 ...
 <main>
     <div class="lg:flex -mx-3">
         <div class="lg:w-3/4 px-3 mb-6">   
              <div class="mb-8">
                  <h2 class="text-default text-lg mb-3">Task</h2>
                  ...
                  <form action="{{$task->path()}}" method="POST">
                           ...
                           @method('PATCH')
                           <div class="flex">
                               <input value="{{$task->body}}" name="body" class="bg-card text-default w-full {{$task->completed ?'text-grey':'' }}">
                  ...
                  <div class="card mb-3">
                    <form action="{{$project->path(). '/tasks'}}" method="POST">
                      @csrf
                            <input type="text" name="body"placeholder="Add new task..." class="bg-card text-default w-full">
                        </form> </div>
             ...
             <div>
                 <h2 class="text-lg text-muted font-light mb-3 ">Notes</h2>
